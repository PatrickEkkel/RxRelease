class HandlerRequest:
    ...
    def getAsPayload(self):
        payload = "hostid=" + str(self.getHostId()) + "," + "ipaddress=" + str(
            self.getIpAddress()) + "," + "statetypeid=" + str(
            self.getStateTypeId()) + "," + "handlerCommand=" + self.getHandlerCommand() + "," + "keyvalList=" + self.getKeyValList()
        return payload

    def __str__(self):
        return '{ "host_id": "' + str(self.getHostId()) + '", "statetype_id": "' + str(
            self.getStateTypeId()) + '", "keyvalList": "' + self.getKeyValList() + '",  "handlerType": "python","handlerCommand": "' + self.getHandlerCommand() + '"  }'
