...
class Shell:
    ...
    def scp_file(self,connection_details,source,destination):
     if not connection_details.use_keys:
      command =  'sshpass -p ' + connection_details.password + ' scp ' + source + ' ' + connection_details.username + '@' + connection_details.ipaddress + ':' + destination
      print(command)
      return call(command,shell=True)
     else:
      command =  'scp ' + source + ' ' + connection_details.username + '@' + connection_details.ipaddress + ':' + destination
      print(command)
      return call(command,shell=True)
