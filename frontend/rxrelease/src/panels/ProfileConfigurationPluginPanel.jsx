...
const ConnectedProfileConfigurationPluginPanel = connect(mapStateToProps)(ProfileConfigurationPluginPanel)

export default ConnectedProfileConfigurationPluginPanel;
