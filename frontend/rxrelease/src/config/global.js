...
constructor() {
  ...
  this.ENABLED_LOGGING = ['TOPLEVEL.COMPONENTCONTAINER','REDUCER.SALT_CONFIGURATION1','REDUCER.SALT_CONFIGURATION','SALT_CONFIGURATION.ACTIONCREATOR','SALT.CONFIGURATIONPANEL']
