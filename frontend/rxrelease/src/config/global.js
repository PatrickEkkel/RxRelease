...
constructor() {
  ...
  this.ENABLED_LOGGING = ['STATETYPES.ACTIONCREATOR','STATES.STATETYPES_PANEL','REDUCER.STATETYPE','STATES.STATETYPES_PARENT_PANEL','STATES.STATETYPE_MANAGEMENT_PANEL']
